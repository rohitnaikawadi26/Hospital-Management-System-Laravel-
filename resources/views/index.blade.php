      ...
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
         <div class="row">
            <div class="service-time one" style="background:#2895f1;">
               ...
               <p>For emergency cases, our team is available 24/7 to provide immediate, life-saving care with expert precision and attention.</p>
            </div>
         </div>
      </div>
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
      ...
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
         <div class="row">
            <div class="service-time three" style="background:#0060b1;">
               ...
               <p>Our clinic is open Monday to Friday from 9 AM to 6 PM, and Saturday from 9 AM to 1 PM, with emergency services available 24/7.</p>
            </div>
         </div>
      </div>
   </div>
      ...
      <div class="row">
         <div class="col-md-6">
            <div class="message-box">
               ...
               <p class="lead">Our clinic offers a wide range of services, including general health check-ups, diagnostics, and specialized treatments for various conditions. We also provide preventive care, chronic disease management, and wellness programs to support long-term health.</p>
             ...
             <div class="inner-services">
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                   <div class="serv">
                      ...
                      <p>LOur clinic offers premium facilities, including private consultation rooms, advanced medical equipment, and a comfortable, luxurious environment for an exceptional healthcare experience.</p>
                   </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                   <div class="serv">
                      ...
                      <p>Our state-of-the-art laboratory is equipped with advanced technology to provide accurate diagnostics and timely test results for a wide range of medical conditions.</p>
                   </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                   <div class="serv">
                      ...
                      <p>Our clinic features a team of highly experienced specialists, providing detailed and expert care tailored to each patient's unique medical needs.</p>
                   </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                   <div class="serv">
                      ...
                      <p>Our children's care center offers compassionate, specialized healthcare services designed to meet the unique needs of infants, children, and adolescents in a safe and welcoming environment.</p>
                   </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                   <div class="serv">
                      ...
                      <p>Our clinic boasts fine infrastructure, featuring modern design, spacious facilities, and the latest medical technology to ensure optimal patient care and comfort.</p>
                   </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                   <div class="serv">
                      ...
                      <p>Our 24/7 blood bank ensures the availability of safe, life-saving blood and blood products at any time, for emergencies and routine needs.</p>
                   </div>
                </div>
             </div>
          </div>
      ...
      <div class="row dev-list text-center">
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.2s; animation-name: fadeIn;">
              <div class="widget clearfix">
                  ...
                  <!-- end title -->
                  <p>Hello, I’m Dr. Emilia from HealthFirst, a senior physician and the founder of WellnessHub, dedicated to providing holistic care for all patients.</p>
          ...
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.4s; animation-name: fadeIn;">
              <div class="widget clearfix">
                  ...
                  <!-- end title -->
                  <p>Hi, I’m Dr. Monika from MediCare, a senior consultant, and the founder of LifeLine Health, focused on delivering personalized healthcare solutions.</p>
          ...
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeIn">
              <div class="widget clearfix">
                  ...
                  <!-- end title -->
                  <p>Greetings, I’m Dr. Lokesh from VitalCare, a leading specialist in neurology and the founder of NeuroCure, committed to advancing brain health and patient well-being.</p>
