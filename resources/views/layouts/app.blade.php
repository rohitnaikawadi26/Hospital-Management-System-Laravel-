                    ...
                    <div class="header-info">
                        <div class="info-inner">
                            ...
                            <span class="iconcont"><a
                                    href="tel:{{ $settings["phone"] ?? '950 987 805' }}">{{ $settings["phone"] ?? '950 987 805' }}</a></span>
                        </div>
                        <div class="info-inner">
                            <span class="icontop"><i class="fa fa-envelope" aria-hidden="true"></i></span>
                            <span class="iconcont"><a data-scroll
                                    href="mailto:{{ $settings["email"] ?? 'rohit@test.com' }}">{{ $settings["email"] ?? 'rohit@test.com' }}</a></span>
                        </div>
                        <div class="info-inner">
                ...
                <div class="col-md-4">
                    <div class="logo padding">
                        <a href="{{ url('/') }}"><img src="{{ 'storage/'.$settings["logo"] ??  config("app.url").'images/logo.png' }}"
                                alt=""></a>
                        <p>{{ $settings["description"] ?? 'Hi, this is Urban Harvest, farm-to-table fusion with a touch of sustainability, small-batch brews, locally-sourced gourmet, and a sprinkle of eco-conscious vibes.' }}
                        </p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="footer-info padding">
                        ...
                        <p><i class="fa fa-map-marker"
                                aria-hidden="true"></i>{{ $settings["address"] ?? 'Mumbai Maharashtra India' }}
                        </p>
                        <p><i class="fa fa-paper-plane"
                                aria-hidden="true"></i>{{ $settings["email"] ?? 'rohit@test.com' }}
                        </p>
                        <p><i class="fa fa-phone"
                                aria-hidden="true"></i>{{ $settings["phone"] ?? '950 987 805' }}</p>
                    </div>
                </div>
                @livewire('subscribe')
            </div>
